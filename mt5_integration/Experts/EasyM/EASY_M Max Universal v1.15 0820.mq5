...
#property description "EasyM MAX Universal v1.15 0820"
...
void DashboardBuild()
{
   ...
   DashMakeText(DashNameRC("C_TAG",0,5),t, cy0+tyPad, g_guard_ok ? "=== EasyM MAX Universal v1.15 0820 ===":" ", DASH_GOLD, fs, 20020);
...
void DashboardUpdate()
{
   ...
   ObjectSetString(g_dashChart, DashNameRC("C_TAG",0,5), OBJPROP_TEXT, g_guard_ok ? "=== EasyM MAX Universal v1.15 0820 ===":" ");
