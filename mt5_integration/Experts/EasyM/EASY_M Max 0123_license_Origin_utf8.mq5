...
#property description "EASY_M Multi-Symbol (10Pairs) 012326"
...
static const bool   GUARD_ENABLE      = true;   // Master switch
static const double GUARD_MIN_BALANCE = 50000.0;   // <==== Minimum balance (account currency). 0=disable ====
// [GUARD] Expiry date (server time). Empty = no expiry.
static const string GUARD_EXPIRE_DATE = "2026.03.31"; // <==== YYYY.MM.DD ====
