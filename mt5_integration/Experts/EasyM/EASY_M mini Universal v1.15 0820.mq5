...
#property description "EasyM mini Universal v1.15 0820"
...
void DashboardBuild()
{
   ...
   DashMakeText(DashNameRC("C_TAG",0,5),t, cy0+tyPad, g_guard_ok ? "=== EasyM mini Universal v1.15 0820 ===":" ", DASH_GOLD, fs, 20020);
...
void DashboardUpdate()
{
   ...
   ObjectSetString(g_dashChart, DashNameRC("C_TAG",0,5), OBJPROP_TEXT, g_guard_ok ? "=== EasyM mini Universal v1.15 0820 ===":" ");
//DashMakeRect(DashName("CBG"), cx0, cy0,      cW, rowH, g_guard_ok ? clrDarkRed:clrDarkViolet, 150, 20000);
