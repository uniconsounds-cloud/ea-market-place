...
//                Forced a minimum 7-day history sync on boot to automatically self-heal recent history.
//+------------------------------------------------------------------+
...
#property description "EasyM MAX Universal v1.16 0904"
...
void DashboardBuild()
{
   ...
   DashMakeText(DashNameRC("C_TAG",0,5),t, cy0+tyPad, g_guard_ok ? "=== EasyM MAX Universal v1.16 0904 ===":" ", DASH_GOLD, fs, 20020);
...
void DashboardUpdate()
{
   ...
   ObjectSetString(g_dashChart, DashNameRC("C_TAG",0,5), OBJPROP_TEXT, g_guard_ok ? "=== EasyM MAX Universal v1.16 0904 ===":" ");
